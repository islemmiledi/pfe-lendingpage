        ...
        <div className="flex justify-between items-end mb-28 max-md:flex-col max-md:items-start max-md:gap-5 max-md:mb-20">
          ...
          <div>
            <button className="py-4 px-9 text-xl group relative text-white bg-[orangered] rounded-sm">
              ...
              <span className="buttonSpan">MORE GYMS</span>
            </button>
          </div>
        </div>
          ...
          {oursalles.map((val) => (
            <div key={val.name} className="group relative overflow-hidden">
              <img
                src={val.img}
                alt="Gym"
                className="h-full object-cover max-sm:h-[65vh]"
              />

              <div className="absolute bottom-[-50px] duration-[.4s] group-hover:bottom-0 left-0 w-full group-hover:bg-[#f04e3c] p-7 pb-8">
                ...
                <h1 className="font text-xl font-semibold text-white">
                  {val.name}
                </h1>
