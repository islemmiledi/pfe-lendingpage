    ...
    <div className="container-lg container-fluid-lg gym-class mb-5">
      <div className="row px-lg-3 pt-lg-0 pt-4 mt-5 mt-lg-0">
        <div className="col-md-6 p-0">
          <div
            id="box-1"
            className="gym-class-box d-flex flex-column align-items-sm-start align-items-center align-items-md-end justify-content-center text-right text-white px-5"
          >
            ...
            <Link
              to="/"
              className="btn btn-lg btn-outline-light mt-4 px-4 rounded-0"
            >
              Join Now
            </Link>
          </div>
        ...
        <div className="col-md-6 p-0">
          <div
            id="box-2"
            className="gym-class-box d-flex flex-column align-items-sm-start align-items-center justify-content-center text-left text-white px-5"
          >
